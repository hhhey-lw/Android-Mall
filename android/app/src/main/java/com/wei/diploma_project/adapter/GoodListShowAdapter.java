...
/* 某大类商品 list => view */
public class GoodListShowAdapter extends RecyclerView.Adapter<GoodListShowAdapter.GoodViewHolder> {
    ...
    public GoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.good_list_show_item, parent, false);
